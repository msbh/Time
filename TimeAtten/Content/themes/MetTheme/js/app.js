var App = function () {
    ...
    var handleLoginForm = function () {
        ...
        //            equalTo: "#RegisterViewModel_Password"
        //        },
    ...
    var handleEditableTables = function () {
        ...
        $('#sample_editable_1 a.edit').live('click', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                var jqInputs2 = $('input', nEditing);
                alert("Updated! Do not forget to do some ajax to sync with backend :)" + jqInputs2[0].value);
                nEditing = null;
    ...
    var handleUserTables = function () {
	            ...
	            function saveRow(oTable, nRow) {
	                var jqInputs = $('input', nRow);
	                $.post("/Admin/GroupApplication/CreateUsr?name=" + jqInputs[0].value + "&Description=" + jqInputs[1].value, function (data) {
	                    alert("Saved ! " + data );
	                });
	                alert(jqInputs[0].value);
	                oTable.fnUpdate(jqInputs[0].value, nRow, 0, false);
	            ...
	            var oTable = $('#user_table_1').dataTable();
	            jQuery('#user_table_1_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
	            jQuery('#user_table_1_wrapper .dataTables_length select').addClass("m-wrap xsmall"); // modify table per page dropdown

	            var nEditing = null;

	            $('#user_table_1_new').click(function (e) {
	                e.preventDefault();
	                var aiNew = oTable.fnAddData(['', '',
                        '<a class="edit" href="">Edit</a>', '<a class="cancel" data-mode="new" href="">Cancel</a>']);
	                var nRow = oTable.fnGetNodes(aiNew[0]);
	            ...
	            $('#user_table_1 a.delete').live('click', function (e) {
	                e.preventDefault();
	            ...
	            $('#user_table_1 a.cancel').live('click', function (e) {
	                e.preventDefault();
	                if ($(this).attr("data-mode") == "new") {
	                    var nRow = $(this).parents('tr')[0];
	                    oTable.fnDeleteRow(nRow);
	            ...
	            $('#user_table_1 a.edit').live('click', function (e) {
	                e.preventDefault();
    ...
    var handleOwnerUserTables = function () {
        ...
        function saveRow(oTable, nRow) {
            var jqInputs = $('input', nRow);
            $.post("/Admin/OwnerCreate/Create?name=" + jqInputs[0].value + "&Description=" + jqInputs[1].value, function (data) {
                alert("Saved ! " + data);
            });
            alert(jqInputs[0].value);
            oTable.fnUpdate(jqInputs[0].value, nRow, 0, false);
        ...
        var oTable = $('#Owner_table_1').dataTable();
        jQuery('#Owner_table_1_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
        jQuery('#Owner_table_1_wrapper .dataTables_length select').addClass("m-wrap xsmall"); // modify table per page dropdown

        var nEditing = null;

        $('#Owner_table_1_new').click(function (e) {
            e.preventDefault();
            var aiNew = oTable.fnAddData(['', '',
                '<a class="edit" href="">Edit</a>', '<a class="cancel" data-mode="new" href="">Cancel</a>']);
            var nRow = oTable.fnGetNodes(aiNew[0]);
        ...
        $('#Owner_table_1 a.delete').live('click', function (e) {
            e.preventDefault();
        ...
        $('#Owner_table_1 a.cancel').live('click', function (e) {
            e.preventDefault();
            if ($(this).attr("data-mode") == "new") {
                var nRow = $(this).parents('tr')[0];
                oTable.fnDeleteRow(nRow);
        ...
        $('#Owner_table_1 a.edit').live('click', function (e) {
            e.preventDefault();
